...
/**
 * Flight identifier consisting of ICAO carrier, flight number and an optional suffix. These components are typically concatenated into a single string when presented for display.
 * 
 * <p>ICAOFlightIdentifier complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ICAOFlightIdentifier">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="CarrierICAOCode" type="{http://schema.ultra-as.com}CarrierICAOCode"/>
...
@XmlType(name = "ICAOFlightIdentifier", propOrder = {
    "carrierICAOCode",
    "flightNumber",
    "flightSuffix"
})
public class ICAOFlightIdentifier {

    @XmlElement(name = "CarrierICAOCode", required = true, nillable = true)
    protected String carrierICAOCode;
     ...
     *     
     */
    public void setCarrierICAOCode(String value) {
