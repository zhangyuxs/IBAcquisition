 ...
 * 
 * <p>IATAFlightIdentifier complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="IATAFlightIdentifier">
 *   &lt;complexContent>
...
@XmlType(name = "IATAFlightIdentifier", propOrder = {
    "carrierIATACode",
    "flightNumber",
    "flightSuffix"
})
public class IATAFlightIdentifier {

    @XmlElement(name = "CarrierIATACode", required = true)
